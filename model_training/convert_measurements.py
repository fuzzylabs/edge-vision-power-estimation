...
from data_preparation.measurement_utils import read_measurement_data
...
def main(save_path: Path, measurements_path: Path, engine_info_path: Path) -> None:
    ...
    measurements = read_measurement_data(measurements_path)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Convert measurements taken on an edge device into training data.")
    parser.add_argument("save_path", type=Path, help="Path to save the resulting training data.")
    parser.add_argument("measurements_path", type=Path, help="Path to the measurements file.")
    parser.add_argument("engine_info_path", type=Path, help="Path to TensorRT engine info generated file.")
